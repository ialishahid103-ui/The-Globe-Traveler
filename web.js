...
function calculatePrice() {
    ...
    // This value is taken from tourPrices, but only if a specific hotel was NOT selected.
    // If you always want to add the tour price, remove the 'if' condition below.
